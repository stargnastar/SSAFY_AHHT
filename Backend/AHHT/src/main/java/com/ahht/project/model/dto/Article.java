...
public class Article {
	...
	public Article(int id, int writerId, String title, String content, String photo, Date regDate, Date updateDate,
			int viewCnt, int boardId, String fileName, String fileUri, MultipartFile file) {
		super();
		this.id = id;
