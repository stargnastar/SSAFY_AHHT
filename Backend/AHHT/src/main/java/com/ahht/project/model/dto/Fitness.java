...
public class Fitness {
	...
	public Fitness(int id, int time, int strength, int cal, int userId, String part, String photo, String content,
			String fileName, String fileUri, MultipartFile file) {
		super();
		this.id = id;
		this.time = time;
